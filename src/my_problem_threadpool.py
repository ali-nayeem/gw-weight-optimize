...
class GW(ElementwiseProblem):
    def __init__(self, sample_id: int, sample_path: str, feature_names: list, init_weight, **kwargs):
        ...
        super().__init__(n_var=8, n_obj=3, n_constr=7, xl=2, xu=50, **kwargs)
...
if __name__ == '__main__':
    ...
    eval = EvaluatePop()
    prob = GW(0, Input.sample_path, Input.input_features_label, Input.ahp_weight, runner=pool.starmap, func_eval=starmap_parallelized_eval)
    x = [ ]
